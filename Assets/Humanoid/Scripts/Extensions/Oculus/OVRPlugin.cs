...
internal static class OculusPlugin
{
	...
	{
		get {
			return OVRP_1_1_0.ovrp_GetInitialized() == OculusPlugin.Bool.True;
		}
	}
	...
	public static bool chromatic
	{
		get {
			if (version >= OVRP_1_7_0.version)
				return OVRP_1_7_0.ovrp_GetAppChromaticCorrection() == OculusPlugin.Bool.True;
	...
	{
		get { return OVRP_1_1_0.ovrp_GetAppMonoscopic() == OculusPlugin.Bool.True; }
	...
	public static bool useIPDInPositionTracking
	{
		get {
			if (version >= OVRP_1_6_0.version)
				return OVRP_1_6_0.ovrp_GetTrackingIPDEnabled() == OculusPlugin.Bool.True;
	...
	public static bool headphonesPresent { get { return OVRP_1_3_0.ovrp_GetSystemHeadphonesPresent() == OculusPlugin.Bool.True; } }
	...
	private static GUID _nativeAudioOutGuid = new OculusPlugin.GUID();
		...
		get {
			try
			{
				if (_nativeAudioOutGuid == null)
					_nativeAudioOutGuid = new OculusPlugin.GUID();
	...
	private static GUID _nativeAudioInGuid = new OculusPlugin.GUID();
		...
		get {
			try
			{
				if (_nativeAudioInGuid == null)
					_nativeAudioInGuid = new OculusPlugin.GUID();
	...
	public static bool GetBoundaryConfigured()
	{
		if (version >= OVRP_1_8_0.version)
		{
			return OVRP_1_8_0.ovrp_GetBoundaryConfigured() == OculusPlugin.Bool.True;
		}
		else
		{
			return false;
	...
	public static bool SetBoundaryLookAndFeel(BoundaryLookAndFeel lookAndFeel)
	{
		if (version >= OVRP_1_8_0.version)
		{
			return OVRP_1_8_0.ovrp_SetBoundaryLookAndFeel(lookAndFeel) == OculusPlugin.Bool.True;
		}
		else
		{
			return false;
	...
	public static bool ResetBoundaryLookAndFeel()
	{
		if (version >= OVRP_1_8_0.version)
		{
			return OVRP_1_8_0.ovrp_ResetBoundaryLookAndFeel() == OculusPlugin.Bool.True;
		}
		else
		{
			return false;
	...
	public static bool GetBoundaryGeometry2(BoundaryType boundaryType, IntPtr points, ref int pointsCount)
	{
		...
		{
			return OVRP_1_9_0.ovrp_GetBoundaryGeometry2(boundaryType, points, ref pointsCount) == OculusPlugin.Bool.True;
		}
		else
		{
			pointsCount = 0;
	...
	public static bool ResetAppPerfStats()
	{
		if (version >= OVRP_1_9_0.version)
		{
			return OVRP_1_9_0.ovrp_ResetAppPerfStats() == OculusPlugin.Bool.True;
		}
		else
		{
			return false;
	...
	public static double GetHandNodePoseStateLatency()
	{
		...
		{
			double value = 0.0;
			if (OVRP_1_18_0.ovrp_GetHandNodePoseStateLatency(out value) == OculusPlugin.Result.Success)
			{
				return value;
			}
			else
	...
	public static bool SetDesiredEyeTextureFormat(EyeTextureFormat value)
	{
		if (version >= OVRP_1_11_0.version)
		{
			return OVRP_1_11_0.ovrp_SetDesiredEyeTextureFormat(value) == OculusPlugin.Bool.True;
		}
		else
		{
			return false;
	...
	public static int GetExternalCameraCount()
	{
		if (version >= OVRP_1_15_0.version)
		{
			...
			if (result != OculusPlugin.Result.Success)
			{
	...
	public static bool GetBoundaryVisible()
	{
		if (version >= OVRP_1_8_0.version)
		{
			return OVRP_1_8_0.ovrp_GetBoundaryVisible() == OculusPlugin.Bool.True;
		}
		else
		{
			return false;
	...
	public static bool SetBoundaryVisible(bool value)
	{
		if (version >= OVRP_1_8_0.version)
		{
			return OVRP_1_8_0.ovrp_SetBoundaryVisible(ToBool(value)) == OculusPlugin.Bool.True;
		}
		else
		{
			return false;
	...
	{
		return (b) ? OculusPlugin.Bool.True : OculusPlugin.Bool.False;
	}
